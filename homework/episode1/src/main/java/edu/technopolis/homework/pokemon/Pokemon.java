...
import main.java.edu.technopolis.homework.pokemon.Attack;
import main.java.edu.technopolis.homework.pokemon.Protection;
...
public class Pokemon {
    ...
    private int power; //сила покемона, когда она заканчивается, заканчивается бой покемонов
