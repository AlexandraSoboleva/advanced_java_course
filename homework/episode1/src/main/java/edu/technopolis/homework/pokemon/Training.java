...
public class Training {
    private  static Attack[] attacks = {new Attack("Spark", 100, 50), new Attack("Thunder", 102, 40), new Attack("Water Gun", 60, 20), new Attack("Psychic", 120, 100)};
    private static Protection[] protections = {new Protection("ProSpark", 70, 50), new Protection("Thunder Punch", 60, 33), new Protection("Confusion", 78, 34), new Protection("ProPsychic", 55, 33)};
